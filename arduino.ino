...
const char* topik_temperature = "G.231.22.0030/temperature"; 
const char* topik_humidity = "G.231.22.0030/humidityy";   
const char* topik_control = "G.231.22.0030/control";
...
void reconnect() {
    while (!client.connected()) {
        ...
        if (client.connect("G.231.22.0030", "usm", "usmjaya001")) {
...
void loop() {
    ...
    client.publish("G.231.22.0030/humidity", dataHumidity.c_str());  
    
    Serial.println("Temperature: " + dataSuhu);
    Serial.println("Humidity: " + dataHumidity);

    
    client.publish("G.231.22.0030/temperature", dataSuhu.c_str());  
